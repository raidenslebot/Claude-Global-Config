...
| **MCP** | `playwright` and `context7`, installed locally and pinned — both keyless — **and the browser itself**, because `playwright-core` ships none and without one no render, audit, motion capture or print proof can run |
